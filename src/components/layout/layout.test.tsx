    ...
    test('test layout', () => { 
        server.use(http.get('https://cloud.appwrite.io/v1/account', async () => {
            ...
            return HttpResponse.json({
                ...
                "status": true,
                "labels": [],
                "passwordUpdate": "2024-08-05T09:43:08.564+00:00",
                ...
                "targets": [
                    {
                        ...
                        "$createdAt": "2024-08-05T09:43:08.619+00:00",
                        "$updatedAt": "2024-08-05T09:43:08.619+00:00",
                        "name": "",
                        "userId": "66b09eaa00239f5c3bb4",
                        "providerId": null,
                        "providerType": "email",
                        "identifier": "akintobi41moyinoluwa@gmail.com"
                    }
                ],
        ...
        expect(screen.getByTestId('layout-routes')).toBeInTheDocument();
