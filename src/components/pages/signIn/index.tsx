...
const SignIn: FC<{
  ...
  return (
    <section className="bg-[var(--white)] lg:max-w-lg lg:mx-auto h-[500px] md:h-[62%] max-h-[450px] flex flex-col absolute bottom-0 w-full p-6 transition-all duration-[1s] md:w-[55%] md:top-1/2 md:left-1/2 md:[transform:translate(-50%,-50%)] md:mx-auto md:my-0">
      <CloseIcon
      ...
      <form
        ...
        className="flex flex-col gap-y-3 text-sm max-w-lg mt-4 mx-auto w-full"
      >
        <Input
          label="Email"
          styles="px-[12px]"
