...
const MockComponent = () => (
    <TestComponentWrapper><SignUp /> </TestComponentWrapper>
)
...
describe('testing sign up inputs', () => {
    test('renders all input fields', () => {
        ...
        const name = screen.getAllByPlaceholderText('name should not be more than 20 characters')
        const pword = screen.getAllByPlaceholderText('Enter password (8-15 characters)')
        ...
        test('toggles password visibility', () => {
            ...
            const passwordInput = screen.getAllByPlaceholderText('Enter password (8-15 characters)')[0];
            const toggleButton = screen.getAllByTestId('eye-slash-icon')[0];
