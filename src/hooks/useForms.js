...
import { hasNumber, specialChars } from "../utils/testInput/testInput";
import { days, daysInMonth, months } from "../utils/constants/constants";
...
const useForms = () => {
  ...
  const data = {birthday, pword, pvalid, fName, lName, errorMsg, setErrorMsg, register, handleSubmit, formState, watch }
  return {data }
}
